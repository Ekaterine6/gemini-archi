        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-24 gap-8">
          <div className="max-w-xl">
            ...
            <h2 className="text-4xl md:text-6xl font-serif leading-tight">
              {language === "ru"
                ? <>Поднимая стандарты <span className="italic">современной жизни.</span></>
          ...
          <p className="text-zinc-400 max-w-xs text-sm leading-relaxed">
            {language === "ru"
              ? "Наш многопрофильный подход гарантирует точность в каждой детали — от конструкции до финальной отделки."
